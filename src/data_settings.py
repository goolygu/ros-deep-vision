...
class DataSettings:
    def __init__(self):
        ...
        self.filter_test = 'top' # 'all' # 'top'
        self.conv5_top = 3
        self.conv4_top = 3
        self.conv3_top = 3

        self.thres_conv5_test = 0# 15#20
        self.thres_conv4_test = 0#5# 3#2
        self.thres_conv3_test = 0#0.2# 0.1#0.2
    ...
    def get_test_name(self):
        name =  self.filter_test + '_' + \
                ...
                '(' + str(self.thres_conv5_test) + '-' + str(self.thres_conv4_test) + '-' + str(self.thres_conv3_test) + ')'
