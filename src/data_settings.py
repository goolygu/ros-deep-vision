...
class DataSettings:
    def __init__(self, tbp):
        ...
        if tbp:
            ...
            self.n_conv4_f = 3#9#3
            self.n_conv3_f = 3#27#3
        else:
            self.n_conv5_f = 0#3#0#3#5
            self.n_conv4_f = 9#3#9#3
            self.n_conv3_f = 27#3#27#3
        ...
        if tbp:
            ...
            self.conv4_top = 2#9#3
            self.conv3_top = 2#27#3
        else:
            self.conv5_top = 0#3#0#3#3
            self.conv4_top = 4#3#9#3
            self.conv3_top = 8#3#27#3
